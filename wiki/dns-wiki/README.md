...
> Offizielle Dokumentation für [atc-dns](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-dns) — **Dezentrales DNS (.atc)** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--dns-blue)](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-dns)
...
**→ [atc-dns](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-dns)** (`main` Branch)

---

## 📚 Dokumentation & Themen-Kapitel

- **[System-Architektur](docs/ARCHITECTURE.md)** — On-Chain Registrar, Caching Engine & Record Types
- **[Roadmap](docs/ROADMAP.md)** — Geplante DNS Features und ZK Identity Resolution
