...
> Offizielle Dokumentation für [atc-contracts](https://github.com/A-TownChain-Okosystems/atc-contracts) — **L4/L11 Contracts** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc-contracts-blue)](https://github.com/A-TownChain-Okosystems/atc-contracts)
...
**→ [atc-contracts](https://github.com/A-TownChain-Okosystems/atc-contracts)** (`main` Branch)
