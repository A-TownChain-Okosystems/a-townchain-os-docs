...
> Offizielle Dokumentation für [atc-drivers](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-drivers) — **Hardware Drivers** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--drivers-blue)](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-drivers)
...
**→ [atc-drivers](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-drivers)** (`main` Branch)

---

## 📚 Dokumentation & Themen-Kapitel

- **[System-Architektur](docs/ARCHITECTURE.md)** — HAL Abstraktionsschicht & Kernel Interface
- **[Treiber-Liste](docs/DRIVER_LIST.md)** — Katalog aller verfügbaren Gerätetreiber
- **[Roadmap](docs/ROADMAP.md)** — Geplante Treiber für NVMe, USB 3.0 und GPU Acceleration
