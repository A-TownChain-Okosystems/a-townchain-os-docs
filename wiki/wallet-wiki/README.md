...
> Offizielle Dokumentation für [atc-wallet](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-wallet) — **L10 Wallet App** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--wallet-blue)](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-wallet)
...
**→ [atc-wallet](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-wallet)** (`main` Branch)
...
- **[Architektur](docs/ARCHITECTURE.md)** — HD-Wallet Struktur und Key-Derivation
- **[Sicherheit](docs/SECURITY.md)** — Schlüsselverschlüsselung, Multi-Sig und Air-Gapped Signing
- **[Roadmap](docs/ROADMAP.md)** — Entwicklungsmeilensteine
