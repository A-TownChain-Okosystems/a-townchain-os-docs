...
> Offizielle Dokumentation für [atc-backend](https://github.com/A-TownChain-Okosystems/atc-backend) — **Backend API & Orchestrator** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--backend-blue)](https://github.com/A-TownChain-Okosystems/atc-backend)
...
**→ [atc-backend](https://github.com/A-TownChain-Okosystems/atc-backend)** (`main` Branch)
