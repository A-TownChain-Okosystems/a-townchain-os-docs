...
> Offizielle Dokumentation für [atc-backend](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-backend) — **Backend API & Orchestrator** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--backend-blue)](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-backend)
...
**→ [atc-backend](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-backend)** (`main` Branch)

---

## 📚 Dokumentation & Themen-Kapitel

- **[System-Architektur](docs/ARCHITECTURE.md)** — Detaillierte Architektur, Orchestrator & Datenfluss
- **[API Reference](docs/API.md)** — Vollständige REST & JSON-RPC Schnittstellenspezifikation
- **[Roadmap](docs/ROADMAP.md)** — Entwicklungsphasen, geplante Erweiterungen und Meilensteine
