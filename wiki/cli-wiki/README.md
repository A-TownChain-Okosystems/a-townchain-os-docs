...
> Offizielle Dokumentation für [atc-cli](https://github.com/A-TownChain-Okosystems/atc-cli) — **Command-Line Tool** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--cli-blue)](https://github.com/A-TownChain-Okosystems/atc-cli)
...
**→ [atc-cli](https://github.com/A-TownChain-Okosystems/atc-cli)** (`main` Branch)
