...
> Offizielle Dokumentation für [atc-cli](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-cli) — **Command-Line Tool** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--cli-blue)](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-cli)
...
**→ [atc-cli](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-cli)** (`main` Branch)

---

## 📚 Dokumentation & Themen-Kapitel

- **[Befehlsübersicht](docs/COMMANDS.md)** — Vollständige CLI Handbuch-Dokumentation
- **[Roadmap](docs/ROADMAP.md)** — Geplante CLI Erweiterungen und TUI Support
