...
> Offizielle Dokumentation für [atc-ci](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-ci) — **CI/CD Pipelines & DevOps** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--ci-blue)](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-ci)
...
**→ [atc-ci](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-ci)** (`main` Branch)

---

## 📚 Dokumentation & Themen-Kapitel

- **[Workflows](docs/WORKFLOWS.md)** — CI/CD Pipeline Spezifikationen & Matrix Configurations
- **[Roadmap](docs/ROADMAP.md)** — Geplante CI-Erweiterungen und Zero-Knowledge Build Verification
