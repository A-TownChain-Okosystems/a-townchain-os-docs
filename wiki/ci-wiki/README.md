...
> Offizielle Dokumentation für [atc-ci](https://github.com/A-TownChain-Okosystems/atc-ci) — **CI/CD Pipelines & DevOps** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--ci-blue)](https://github.com/A-TownChain-Okosystems/atc-ci)
...
**→ [atc-ci](https://github.com/A-TownChain-Okosystems/atc-ci)** (`main` Branch)
