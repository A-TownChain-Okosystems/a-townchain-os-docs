...
> Offizielle Dokumentation für [atc-kernel](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-kernel) — **L2 Kernel** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc-kernel-blue)](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-kernel)
...
**→ [atc-kernel](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-kernel)** (`main` Branch)
