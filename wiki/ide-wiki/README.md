...
> Offizielle Dokumentation für [atc-ide](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-ide) — **L10 IDE Plugins & LSP** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--ide-blue)](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-ide)
...
**→ [atc-ide](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-ide)** (`main` Branch)
...
- **[Architektur](docs/ARCHITECTURE.md)** — Plugin-Architektur und Compiler-Anbindung
- **[LSP Spezifikation](docs/LSP.md)** — Language Server Protocol Protokoll-Details
