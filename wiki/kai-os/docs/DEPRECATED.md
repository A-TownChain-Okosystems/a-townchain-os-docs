...
| `atc-kernel/net/atcnet.py` | atc-kernel | [`atcnet` Repo](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atcnet) | Duplikat entfernt — eigenständiges Repo |
