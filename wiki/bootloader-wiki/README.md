...
> Offizielle Dokumentation für [atc-bootloader](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-bootloader) — **Low-Level Bootloader** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--bootloader-blue)](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-bootloader)
...
**→ [atc-bootloader](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-bootloader)** (`main` Branch)

---

## 📚 Dokumentation & Themen-Kapitel

- **[System-Architektur](docs/ARCHITECTURE.md)** — Boot-Phasen (Stage 1-3), Memory Map & Signature Check
- **[Roadmap](docs/ROADMAP.md)** — Meilensteine für Secure Boot & Multi-Architecture Support
