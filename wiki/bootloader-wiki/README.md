...
> Offizielle Dokumentation für [atc-bootloader](https://github.com/A-TownChain-Okosystems/atc-bootloader) — **Low-Level Bootloader** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--bootloader-blue)](https://github.com/A-TownChain-Okosystems/atc-bootloader)
...
**→ [atc-bootloader](https://github.com/A-TownChain-Okosystems/atc-bootloader)** (`main` Branch)
