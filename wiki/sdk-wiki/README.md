...
> Offizielle Dokumentation für [atc-sdk](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-sdk) — **Multi-Language SDKs** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--sdk-blue)](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-sdk)
...
**→ [atc-sdk](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-sdk)** (`main` Branch)

---

## 📚 Dokumentation & Themen-Kapitel

- **[System-Architektur](docs/ARCHITECTURE.md)** — SDK Sprachbindungen & RPC Protocol Layer
- **[API Reference](docs/API.md)** — Methodenspezifikationen für TypeScript, Python, Rust & Go
- **[Roadmap](docs/ROADMAP.md)** — Geplante SDK Erweiterungen für Mobile & WebAssembly
