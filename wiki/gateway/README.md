...
> Offizielle Dokumentation für [atc-gateway](https://github.com/A-TownChain-Okosystems/atc-gateway) — **L7 API** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc-gateway-blue)](https://github.com/A-TownChain-Okosystems/atc-gateway)
...
**→ [atc-gateway](https://github.com/A-TownChain-Okosystems/atc-gateway)** (`main` Branch)
