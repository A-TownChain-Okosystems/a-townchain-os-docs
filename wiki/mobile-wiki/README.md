...
> Offizielle Dokumentation für [atc-mobile](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-mobile) — **L10 Mobile App** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--mobile-blue)](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-mobile)
...
**→ [atc-mobile](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-mobile)** (`main` Branch)
...
- **[Architektur](docs/ARCHITECTURE.md)** — Mobile Bridge und Biometrie
