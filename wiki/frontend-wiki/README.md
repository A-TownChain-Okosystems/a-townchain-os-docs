...
> Offizielle Dokumentation für [atc-frontend](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-frontend) — **L10 Frontend** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--frontend-blue)](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-frontend)
...
**→ [atc-frontend](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atc-frontend)** (`main` Branch)
...
- **[Architektur](docs/ARCHITECTURE.md)** — Frontend-Schichtenmodell und Gateway-Integration
- **[Komponenten](docs/COMPONENTS.md)** — UI-Struktur, Bootscreen, Neon-Dashboard und Battle Center
- **[Roadmap](docs/ROADMAP.md)** — Entwicklungsstufen v1.0 bis v3.0
