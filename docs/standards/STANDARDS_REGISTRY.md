...
---
## Lizenz-Standards (ATC-LIC / ATS-LIC)

#### ATC-LIC v1.0 — Smart Contract License Protocol DRAFT
**Scope:** ATVM License Gate, Royalty-Durchsetzung, License Registry, IP Dashboard
**Implementation:** Spezifikation — ATVM Gate, Registry Contract und Royalty-Loop geplant
**Referenzen:** ATC-01, ATC-03, ATC-04, ATC-11, ATC-14, ATC-17, ATC-29, ATC-30, ATC-37
**Paradigma:** Monetarisiertes autonomes Open-Source — Code is Law auf Lizenzebene
**Dokument:** [ATC-LIC-SMART_CONTRACT_LICENSE.md](ATC-LIC-SMART_CONTRACT_LICENSE.md)

#### ATS-LIC v1.0 — System & Hardware License Protocol DRAFT
**Scope:** TPM-Attestation, Node-Lizenzierung, Secure Boot, Tamper-Detection
**Implementation:** Spezifikation — ShivaOS Kernel (ATS-1000+) Integration geplant
**Referenzen:** ATC-LIC, ATC-03, ATC-22, ATS-1000+
**Dokument:** [ATS-LIC-SYSTEM_HARDWARE_LICENSE.md](ATS-LIC-SYSTEM_HARDWARE_LICENSE.md)

#### Compliance-Handbuch (BaFin) DRAFT
**Scope:** BaFin-konforme Dokumentation des Lizenzmodells, automatisierte Provisionsabwicklung, Urheberschutz auf Kernel-Ebene
**Dokument:** [COMPLIANCE_HANDBUCH.md](../compliance/COMPLIANCE_HANDBUCH.md)
**Zentrale Uebersicht:** [LICENSING_OVERVIEW.md](../LICENSING_OVERVIEW.md)
