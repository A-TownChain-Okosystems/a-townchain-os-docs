...
## ATC-01 Standard Referenz

> Diese Dokumentation implementiert den [ATC-01 Core Node Protocol Standard]
> (../standards/ATC-01-CORE_NODE_PROTOCOL.md).
>
> **Standard-ID:** ATC-01 v1.0 | **Status:** ✅ FINAL
>
> Spezifikationsquelle: `Atc-01.docx` — Abgeglichen mit Code-Implementation am 04.07.2026 21:09.
>
> Bekannte Abweichungen von der ursprünglichen Spezifikation (alle by design):
> - libp2p → ATCNet (proprietär, non-POSIX)
> - QUIC → TCP/UDP
> - Noise Protocol → ECDSA + SHA-256
> - Ed25519 → ECDSA (secp256k1, ATC-0002 konform)
