...
**Verbindliche Architektur:** [SHIVACORE_KERNEL_ARCHITECTURE.md](architecture/SHIVACORE_KERNEL_ARCHITECTURE.md) · [v0.1 Architektur-Gate (AD-013)](architecture/SHIVACORE_V01_ARCHITECTURE_GATE.md) (AD-012, Microkernel-Spezifikation inkl. Delta-Analyse zu diesem Ist-Stand)
