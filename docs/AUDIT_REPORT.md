...
| #13 | ecdsa.py | SHA-256 statt Keccak-256 (Ethereum-Kompatibilität) | 3.0 |
...
|-----------|--------|--------|
| PoH | H(prev\|\|seq\|\|data) — SHA-3_256, nicht parallelisierbar | ✅ |
...
| ECDSA | secp256k1 + SHA-256 DER-Signatur | ✅ (SHA-256, nicht Keccak) |
