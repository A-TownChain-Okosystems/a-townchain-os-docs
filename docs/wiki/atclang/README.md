...
> Offizielle Dokumentation für [atclang](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atclang) — **L2–L4 Language** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atclang-blue)](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atclang)
...
**→ [atclang](https://github.com/A-TownChain-Okosystems/a-townchain-os/tree/main/src/modules/atclang)** (`main` Branch)
