...
## BaFin-Compliance Entscheidungen

### AD-008 — Lizenzmodell: ATC-LIC / ATS-LIC ✅
**Datum:** 05.07.2026
**Entscheidung:** Etablierung eines monetarisierten, autonomen Open-Source-Oekosystems.
ATC-LIC (Smart Contract Licenses) mit automatischer Royalty-Durchsetzung durch ATVM.
ATS-LIC (System & Hardware Licenses) mit TPM-Verifikation.
"Code is Law" — unlizenzierter Code wird physisch nicht ausgefuehrt.
**Referenz:** [ATC-LIC](standards/ATC-LIC-SMART_CONTRACT_LICENSE.md) | [ATS-LIC](standards/ATS-LIC-SYSTEM_HARDWARE_LICENSE.md)

### AD-009 — BaFin-Konformitaetsbericht erstellt ✅
**Datum:** 06.07.2026
**Entscheidung:** Konformitaetsbericht BAFIN-ATC-LIC-2026-001 als Entwurf v1.0.0 erstellt.
7 Konformitaetskategorien geprueft (alle KONFORM), 32 Audit-Items erfuellt.
Risikoanalyse erstellt (technisch, rechtlich, betrieblich).
**Naechster Schritt:** BaFin-Vorab-Abklaerung einreichen.
**Referenz:** [Konformitaetsbericht](compliance/BAFIN_KONFORMITAETSBERICHT.md)

### AD-010 — Proprietary Lizenz auf 24 Repos ✅
**Datum:** 05.07.2026
**Entscheidung:** Alle 24 GitHub-Repositories auf proprietäre Lizenz (All Rights Reserved)
umgestellt. MIT-License ersetzt. 760+ Source-Dateien mit Copyright-Header versehen.
**Referenz:** [Lizenz-Uebersicht](LICENSING_OVERVIEW.md)
