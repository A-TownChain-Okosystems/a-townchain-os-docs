...
> Offizielle Dokumentation für [atc-shivacore-tools](https://github.com/A-TownChain-Okosystems/atc-shivacore-tools) — **Build Tools** im A-TownChain Ökosystem

**Layer:** L1 | **Version:** v1.0.0
...
Build-Skripte, QEMU-Wrapper und Debug-Tools für den ShivaCore Kernel.
