# 🏛️ Architektur — atc-ci

> **Repo:** [atc-ci](https://github.com/A-TownChain-Okosystems/atc-ci)
> **Layer:** L0 | **Titel:** CI/CD Pipeline
...
GitHub Actions Workflows: Test, Lint, Build, Deploy.
