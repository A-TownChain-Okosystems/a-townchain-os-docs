...
> Offizielle Dokumentation für [atc-linux-edition](https://github.com/A-TownChain-Okosystems/atc-linux-edition) — **Linux Client** im A-TownChain Ökosystem
...
egui Desktop-Client für Linux: Blockchain-Sync + Wallet.
