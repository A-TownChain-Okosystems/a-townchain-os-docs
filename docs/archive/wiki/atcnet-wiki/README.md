...
> Offizielle Dokumentation für [atcnet](https://github.com/A-TownChain-Okosystems/atcnet) — **P2P Network** im A-TownChain Ökosystem

**Layer:** L5 | **Version:** v1.0.0
...
ATCNet P2P Protocol: Discovery, Gossip, NAT Traversal, Bootstrap.
