<!-- PROVENANZ (Org-Adoption 13.09.2026): Quelle: privates archiviertes Repo ShivaCoreDev/A-TownChain--kosystems (Juli-Monolith, Stand 05.07.2026).
Einzige bekannte vollstaendige Software-Roadmap des Oekosystems (39.7 KB): Entwicklungs-Roadmap, Architektur & Tiers (A-TownOS), Oekosystem-Architektur, ATC/ATS-Standards-Historie, System-Wiki-Komponenten, Franchise-Factory-Telemetrie.
Status: ARCHIV-REFERENZ (nicht normativ) — historischer Planungsstand 07/2026; KEINE Verbindlichkeit gegenueber registry/standards.yaml. Claims gegen kanonische Repos pruefen (SCR-0118-Muster). -->
